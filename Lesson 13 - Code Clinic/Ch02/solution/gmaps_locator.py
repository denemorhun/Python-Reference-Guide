...
# refer here: https://developers.google.com/maps/documentation/geolocation/get-api-key
# api key: AIzaSyDGQ8mM3NUUnXgiRhsGtIvjdNSuIBe469U
...
API_KEY = 'AIzaSyDGQ8mM3NUUnXgiRhsGtIvjdNSuIBe469U' # replace with your own Google Maps API key
